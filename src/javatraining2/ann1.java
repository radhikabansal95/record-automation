 ...
 * @author radhika
 */
public class ann1 extends javax.swing.JFrame {

    /**
     * Creates new form ann1
     */
    public ann1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        desc.setColumns(20);
        desc.setRows(5);
        desc.setText("Diwali celebration. Children decorated their classes, made rangoli, painted diyas etc.");
        ...
        // TODO add your handling code here:
         ...
         FileInputStream fis = new FileInputStream(filename);
             ...
             FileInputStream fis2 = new FileInputStream(filename2);
              PreparedStatement ps=c.prepareStatement("insert into annual_grant values(seq6.nextval,'"+date.getText()+"','"+desc.getText()+"',?,?,?,'"+price.getText()+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ann1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
